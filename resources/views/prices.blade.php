        ...
        @if (count($worktypes) > 0)
          ...
          @endauth
                <div class="grid grid-cols-1 p-3 gap-3 h-fit py-3 rounded-sm border border-stroke bg-white pb-2.5 pt-6 shadow-default dark:bg-gray-800 dark:border-gray-800 dark:text-white sm:px-7.5 xl:pb-1">
                    ...
                    @guest
                    <span class="grid-cols-3 px-7.5 py-3 p-2 border-b border-black dark:border-white hover:bg-gray-300 dark:hover:bg-gray-900">
                    ...
                    @endguest
                    @auth
                    <span class="grid-cols-4 px-7.5 py-3 p-2 border-b border-black dark:border-white hover:bg-gray-300 dark:hover:bg-gray-900">
                    ...
                    @endauth
                            ...
                            @auth
                              <button id="{{$worktype->id}}" name="{{$worktype->name}}" onclick="recommendNextAvailable(this)" class="col-span-1 rounded border border-stroke px-6 py-2 font-medium text-black hover:bg-gray-300 dark:hover:bg-gray-800 border dark:text-white dark:bg-gray-900">Reserve</button>
                            @endauth
                          </div>
