        ...
        <form class="col-span-6" action="/admin/menu/events" method="GET">
            <div class="grid grid-cols-5 gap-1">
                    <div class="col-span-1">
                        ...
                        <input value="{{Request::get('appointmentId') ?? '' }}" name="appointmentId" type="number" placeholder="Appointment ID" class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                    </div>
                    <div class="col-span-1">
                        <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                            User name
                        </label>
                        <input value="{{Request::get('userName') ?? '' }}" name="userName" type="text" placeholder="User name" class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                    </div>
                    <div class="col-span-1">
                        <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                            Created at
                        </label>
                        <input value="{{Request::get('createdAt') ?? '' }}" name="createdAt" type="date" class="hover:cursor-pointer w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                    </div>
                    <div class="col-span-1">
                        <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                            Status
                    ...
                    <div class="col-span-1">
                        ...
                        <select name="workType" class="hover:cursor-pointer w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:hover:bg-gray-800 border dark:text-white dark:bg-gray-900">
                    ...
                    <div class="grid grid-cols-2 grid-rows-2 justify-items-center items-center">
                        <div class="col-span-1 row-span-2 mt-3 md:mt-0 self-end">
                        ...
                        <div class="col-span-1 row-span-2 mt-3 md:mt-0 self-end">
                            <a href="/admin/menu/events" class="hover:cursor-pointer flex justify-center rounded border border-stroke px-6 py-2 font-medium text-black hover:bg-red-500 dark:hover:bg-red-500 hover:dark:text-black border dark:text-white dark:bg-gray-900">Reset</a>
                        </div>
                    </div>
            </div>
        </form>
        ...
        @if (count($events) > 0)
            <div class="col-span-5">
                <div class="grid grid-cols-1 gap-1 h-fit py-3 rounded-sm border border-stroke bg-white pb-2.5 pt-6 shadow-default dark:bg-gray-800 dark:border-gray-800 dark:text-white sm:px-7.5 xl:pb-1">
                    ...
                    <a href="/admin/event/{{$event->id}}" class="px-7.5 py-3 border-b hover:bg-gray-300 dark:hover:bg-gray-900">
