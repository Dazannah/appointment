    ...
    <div class="h-screen sticky top-0 flex flex-col items-center h-screen w-16 pb-4 overflow-auto border-r border-gray-300 dark:border-gray-800 dark:text-gray-500">
        ...
        @if (auth()->check())
        <a title="Dashboard" class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-300 dark:hover:bg-gray-800 {{request()->routeIs('dashboard') ? 'bg-gray-300 dark:bg-gray-800 text-black dark:text-white' : ''}}" href="/dashboard">
        ...
        <a title="Prices" class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-300 dark:hover:bg-gray-800 {{request()->routeIs('prices') ? 'bg-gray-300 dark:bg-gray-800 fill-black dark:fill-white' : 'fill-gray-700 dark:fill-gray-500'}}" href="/prices">
            <svg class="w-5 h-5 text-gray-300" viewBox="0 -32 1088 1088" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <a title="Calendar" class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-300 dark:hover:bg-gray-800 {{request()->routeIs('calendar') ? 'bg-gray-300 dark:bg-gray-800 text-black dark:text-white' : ''}}" href="/calendar">
          <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        @if (auth()->check() && auth()->user()->is_admin)
            ...
            <a title="Admin dashboard" class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-300 dark:hover:bg-gray-800 {{request()->routeIs('admin.dashboard') ? 'bg-gray-300 dark:bg-gray-800 text-black dark:text-white' : ''}}" href="/admin/dashboard">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            </a>
            <a title="Admin menu" class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-300 dark:hover:bg-gray-800 {{request()->routeIs(['admin.menu.base', 'admin.menu.users', 'admin.menu.events', 'admin.menu.worktypes', 'admin.menu.closedDays']) ? 'bg-gray-300 dark:bg-gray-800 text-black dark:text-white text-black dark:text-white' : ''}}" href="/admin/menu">
            ...
            <a title="Site settings" class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-300 dark:hover:bg-gray-800 {{request()->routeIs('admin.siteSettings') ? 'bg-gray-300 dark:bg-gray-800 text-black dark:text-white' : ''}}" href="/admin/site-settings">
                <svg class="w-5 h-5"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        @endif
        @if (auth()->check())
            <a title="User profile" class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-auto rounded hover:bg-gray-300 dark:hover:bg-gray-800 {{request()->routeIs('profile.edit') ? 'bg-gray-300 dark:bg-gray-800 text-black dark:text-white' : ''}}" href="/profile">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
