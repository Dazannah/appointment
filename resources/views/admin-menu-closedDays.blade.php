                        ...
                        <div class="grid grid-cols-4 justify-items-center items-center border-stroke hover:bg-gray-300 dark:hover:bg-gray-900 dark:border-strokedark">
                            ...
                            <div class="col-span-1">
                                <form action="/admin/closed-days/delete/{{$closedDay->id}}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <input class="hover:cursor-pointer flex justify-center rounded border border-stroke px-6 py-2 font-medium text-black hover:bg-red-500 dark:hover:bg-red-500 hover:dark:text-black border dark:text-white dark:bg-gray-900" type="submit" value="Delete">
                                </form>
                            </div>
                        </div>
                    </a>
