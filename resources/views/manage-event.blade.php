          ...
          <div class="p-7">
            <form action="/event/{{$event->id}}" method="post">
              ...
              <div class="flex justify-end gap-4.5">
                  ...
                  <a href="/{{Request::get('from') ?? 'dashboard'}}" class="flex justify-center rounded border border-stroke px-6 py-2 font-medium text-black hover:bg-red-500 dark:hover:text-black dark:hover:bg-red-500 border dark:text-white dark:bg-gray-900">
                      Cancel
                  </a>
              </div>
            </form>
